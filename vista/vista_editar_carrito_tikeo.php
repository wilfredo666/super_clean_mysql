 ...
 while($row = pg_fetch_array($query))
  {
      ...
      <input type='hidden' id='ID_carrito_tikeo_edicion' value='<?php echo $ID_carrito_tikeo; ?>'>
       ...
       <?php echo $codigo_barras= trim($row['codigo_barras']); ?> 
        ...
        <input type='text' class='form-control' id='codigo_barras' value='<?php echo $codigo_barras;?>' placeholder='(*)Escriba su codigo_barras' onkeyup="validador_campo('codigo_barras','resp_codigo_barras',4)" maxlength='100' onkeypress='return valida_letras(event);'>
       ...
       <label> estado_tikeo : </label>  
       <?php echo $estado_tikeo= trim($row['estado_tikeo']); ?> 
         
        <input type='text' class='form-control' id='estado_tikeo' value='<?php echo $estado_tikeo;?>' placeholder='(*)Escriba su estado_tikeo' onkeyup="validador_campo('estado_tikeo','resp_estado_tikeo',4)" maxlength='100' onkeypress='return valida_letras(event);'>
