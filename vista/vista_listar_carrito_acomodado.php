    ...
    <div class='col-lg-8 col-xs-12' style='margin: 0px; padding: 0px;' >
         <table class='table table-condensed' style='margin: 0px; padding: 0px;'>
          <tr>
            <td> 
              <input type='text' class='form-control' id='txt_buscar' placeholder='Buscar carrito_acomodado' onkeyup ='cargar_datos_buscar(1);'>
            </td>
            <td>
          ...
          <div id='resp_busqueda_carrito_acomodado' ></div>
      </div>
    ...
    <div class='col-lg-12 col-xs-12' style='background:white; padding:0px; margin:0px; color:#6E6E6E;'>
      ...
      <h3 style='margin-bottom:0px;'> Registros de carrito_acomodado </h3>
      <p style='margin:0px; margin-bottom:3px;'> Listado de todos los datos registrados hasta la ultima fecha : </p>
              
      <div id='panel_listado_carrito_acomodado'> </div>
  ...
  <div class='modal-dialog modal-lg'>
    ...
    <div class='modal-content'>
     <div class='modal-header'>
       ...
       <h4 class='modal-title'> Registrar carrito_acomodado </h4>
     </div>
     
     <div class='modal-body'>

      <div id='panel_registro_carrito_acomodado'>
      </div>

      </div>
      <div class='modal-footer'>
      
      <button type='button' class='btn btn-default btn-md' onclick='btn_registro_carrito_acomodado();'> registrar </button>
...
<script src='../control/control_carrito_acomodado.js'> </script>
