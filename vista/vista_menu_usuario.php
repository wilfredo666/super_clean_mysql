	  ...
	  <div class='container-fluid'>
	    ...
	    <div class='navbar-header'>
	      ...
	      <a class='navbar-brand' href='vista_menu_usuario.php' style='color:orange;'> 
	      	<img src="../multimedia/iconos/logo_superclean.png" style="width: 25px; height: 25px; float: left;"> Super Cleaner </a>
	    </div>
	    ...
	    <div class='collapse navbar-collapse' id='bs-example-navbar-collapse-1'>
          ...
          <ul class='nav navbar-nav hidden-lg hidden-md'>
            ...
            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white; background: transparent;"> Orden de Trabajo <span class="caret"></span></a>
            
               <ul class="dropdown-menu">  
                <li> <a onclick='btn_orden_trabajo();' id="item"> Orden Trabajo </a> </li>
                <li><a onclick='btn_listar_ordenes_trabajo();' id="item">  Lista Ord Trabajo </a></li>
                <li><a onclick='btn_orden_domicilio();' id="item">  Orden a Domicilio </a></li>
                <li><a onclick='btn_listar_orden_domicilio();' id="item">  Lista Ord Domicilio </a></li>
               </ul>
            </li>

            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white; background: transparent;"> Tikeo <span class="caret"></span></a>
            
               <ul class="dropdown-menu"> 
                
                <li> <a onclick='btn_tikeo_cliente();' id="item"> Tikear Prenda Cliente </a> </li> 
                <li> <a onclick='btn_tikeo();' id="item"> Tikeo de Prenda </a> </li>
                <li> <a onclick='btn_listar_tikeo_prenda();' id="item"> Listar Prendas Tikeadas </a> </li>
            ...
            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white; background: transparent;"> Orden y Asignacion <span class="caret"></span></a>
            
               <ul class="dropdown-menu"> 
                
               <li> <a onclick='btn_acomodado();' id="item"> Orden de Prendas </a> </li>
               <li> <a onclick='btn_listar_acomodado();' id="item"> Listar Prendas </a> </li>
            ...
            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white; background: transparent;"> Servicio de Entregas <span class="caret"></span></a>
            
               <ul class="dropdown-menu"> 
                
                <li> <a onclick='btn_entrega();' id="item"> Registrar Entregas </a> </li>
                <li> <a onclick='btn_listar_entrega();' id="item"> Listar Entregas </a> </li>
            ...
            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white; background: transparent;"> Control de Servicios <span class="caret"></span></a>
            
               <ul class="dropdown-menu"> 
                
               <li> <a onclick='btn_almacen();' id="item"> Almacen </a> </li>

               <li> <a onclick='btn_cierre_caja();' id="item" > Cierre Caja </a> </li>

               </ul>
            </li>

            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white; background: transparent;"> Prenda <span class="caret"></span></a>
            
               <ul class="dropdown-menu"> 
                
                <li> <a onclick='btn_prenda();' id="item" > Registrar Prenda </a> </li>
                <li> <a onclick='btn_precio_kilo();' id="item" > Precio Kilo </a> </li>
                <li> <a onclick='btn_tipo_prenda();' id="item" > Tipo Prenda </a> </li>
                <li> <a onclick='btn_moneda();' id="item" > Moneda </a> </li>
                <li> <a onclick='btn_area_acomodado();' id="item" > Area Acomodado </a> </li>

               </ul>
            </li>

            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" style="color:white; background: transparent;"> Datos Empresariales <span class="caret"></span></a>
            
               <ul class="dropdown-menu"> 
                
                <li> <a onclick='btn_sucursal();' id="item" >  Sucursal </a> </li>

                <li> <a onclick='btn_chofer();' id="item" > Choferes </a> </li>

                <li> <a onclick='btn_cliente();' id="item" > Registrar Cliente </a></li>

                <li> <a onclick='btn_usuario();' id="item" > Registrar Usuario </a></li>

                <li> <a onclick='btn_cargo();' id="item" > Registrar Cargo </a> </li>
	...
	<div class='col-lg-2 col-md-2 col-xs-12' style='background: transparent; padding: 0px; margin: 0px;'>
     <div class="hidden-xs">
	 <?php require 'vista_menu_aside.php';?>
     </div>
	</div>
             	...
             	<table>
             		<tr>
                        ...
                        <img src="../multimedia/iconos/procesos/ent.png" style="width: 230px; height: 230px;">
             			...
             			<td style="padding: 1%;">
             			 <label style="font-size: 15px; color: black;"> ENTREGAS DEL DIA </label> </br>
             			<label style="font-size: 10px;"> CANTIDAD : </label> 

             			<?php
                        
                        $fecha_ot = date('Y-m-d'); echo "</br>";
             			
                        $sql_ent = pg_query("SELECT DISTINCT codigo_ot FROM orden_trabajo WHERE estado='ENTREGADO' AND fecha='$fecha_ot'");
             			$contador_ent = 0;
