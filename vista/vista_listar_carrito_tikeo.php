    ...
    <div class='col-lg-8 col-xs-12' style='margin: 0px; padding: 0px;' >
         <table class='table table-condensed' style='margin: 0px; padding: 0px;'>
          <tr>
            <td> 
              <input type='text' class='form-control' id='txt_buscar' placeholder='Buscar carrito_tikeo' onkeyup ='cargar_datos_buscar(1);'>
            </td>
            <td>
          ...
          <div id='resp_busqueda_carrito_tikeo' ></div>
      </div>
  ...
  <div class='modal-dialog modal-lg'>
    ...
    <div class='modal-content'>
     <div class='modal-header'>
       ...
       <h4 class='modal-title'> Registrar carrito_tikeo </h4>
     </div>
     
     <div class='modal-body'>

      <div id='panel_registro_carrito_tikeo'>
      </div>

      </div>
      <div class='modal-footer'>
      
      <button type='button' class='btn btn-default btn-md' onclick='btn_registro_carrito_tikeo();'> registrar </button>
...
<script src='../control/control_carrito_tikeo.js'> </script>
