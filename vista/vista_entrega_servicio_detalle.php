...
<table class="table">
	<tr>
		<td style="padding: 2%;"> 
      <button class="btn btn-primary" onclick="btn_realizar_entrega_pedido();"> FINALIZAR </button>
    </td>
		<td style="padding: 2%; text-align: right;"> 
      <button class="btn btn-success" onclick="btn_realizar_notificacion_pedido('<?php echo $codigo_ot; ?>');"> Notificar </button>
    </td>
	</tr>
</table>
