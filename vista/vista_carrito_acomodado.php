   ...
   <div class='row' style='margin:0px; padding:0px;'> 
    ...
    <h2 align='center'>carrito_acomodado</h2>
   ...
   <div id='resultado_registro_carrito_acomodado'></div> 
   
   </div>
   <script type='text/javascript' src='../control/control_carrito_acomodado.js'></script>
