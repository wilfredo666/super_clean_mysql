    ...
    <div class='col-lg-8 col-xs-12' style='margin: 0px; padding: 0px;' >
         <table class='table table-condensed' style='margin: 0px; padding: 0px;'>
          <tr>
            <td> 
              <input type='text' class='form-control' id='txt_buscar' placeholder='Buscar tikeo' onkeyup ='cargar_datos_buscar(1);'>
            </td>
            <td>
          ...
          <div id='resp_busqueda_tikeo' ></div>
      </div>
    ...
    <div class='col-lg-12 col-xs-12' style='background:white; padding:0px; margin:0px; color:#6E6E6E;'>
      ...
      <h3 style='margin-bottom:0px;'> Registros de tikeo </h3>
...
<script src='../control/control_tikeo_listado.js'> </script>
