	...
	<nav class='navbar navbar-default' style='margin-bottom: 0px; background: #0B3861; margin:0px; border-radius:0px; border:none;'>
	  <div class='container-fluid'>
	    ...
	    <div class='navbar-header'>
	     ...
	     <a class='navbar-brand' href='vista_menu_recepcionista.php' style='color:orange;'> 
          ...
          <ul class='nav navbar-nav hidden-lg hidden-md'>
           ...
           <li class="dropdown">
               ...
               <ul class="dropdown-menu">  
                ...
                <li> <a onclick='btn_lavados_especiales();' class="item"> OT Lavados especiales </a> </li>

                <li> <a onclick='btn_cobro_lavados_especiales();' class="item"> OT Cobros LE </a> </li>
	...
	<div class='col-lg-2 col-md-2 col-xs-12' style='background: #2d2d2d; padding: 0px; margin: 0px;'>
     <div class="hidden-xs">
       <?php require 'vista_menu_aside_recepcionista.php';?>
     </div>
	</div>
