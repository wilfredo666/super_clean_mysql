    ...
    <div class='col-lg-8 col-xs-12' style='margin: 0px; padding: 0px;' >
         <table class='table table-condensed' style='margin: 0px; padding: 0px;'>
          <tr>
            <td> 
              <input type='text' class='form-control' id='txt_buscar' placeholder='Buscar ordenes a domicilio' onkeyup ='cargar_datos_buscar(1);'>
            </td>
            <td>
          ...
          <div id='resp_busqueda_orden_domicilio' ></div>
      </div>
...
<script src='../control/control_ordenes_domicilio.js'> </script>
