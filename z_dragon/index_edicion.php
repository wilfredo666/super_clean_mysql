...
<div class="row">
  ...
  <p> EDICION Area Aplicativa </p>
  <select class="form-control" id="select_areas">
  ...
  <?php
   ...
   $resultado = pg_query("SELECT table_name FROM information_schema.tables WHERE table_schema='public' AND table_type='BASE TABLE'");
