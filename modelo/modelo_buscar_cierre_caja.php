<a href='javascript:void(0);' onclick='btn_cierre_caja();'> Volver </a>
<?php
    ...
    $count_query   = pg_query("SELECT count(*) AS numrows FROM cierre_caja WHERE fecha_cierre = '$txt_buscar'");
    if ($row= pg_fetch_array($count_query)){ $numrows = $row['numrows'];}
    $total_pages = ceil($numrows/$per_page);
    $reload = '../vista/vista_listar_cierre_caja.php';

    //consulta principal para recuperar los datos
    $query = pg_query("SELECT * FROM cierre_caja WHERE fecha_cierre = '$txt_buscar' ORDER BY id_cierre_caja DESC OFFSET $offset LIMIT $per_page");
   }
          ...
          <div class='modal-dialog modal-lg'>
            ...
            <div class='modal-content'>
              <div class='modal-header'>
                ...
                <h4 class='modal-title'> Examinar cierre_caja </h4>
              </div>
        ...
        <div id='myModal_Edicion' class='modal fade' role='dialog'>
          <div class='modal-dialog modal-lg'>
            ...
            <div class='modal-content'>
              <div class='modal-header'>
                <button type='button' class='close' data-dismiss='modal'>&times;</button>
                <h4 class='modal-title'> Editar cierre_caja </h4>
              </div>
              <div class='modal-body'>
        ...
        <div id='myModal_Eliminar' class='modal fade' role='dialog'>
          <div class='modal-dialog'>
            ...
            <div class='modal-content'>
              <div class='modal-header'>
                <button type='button' class='close' data-dismiss='modal'>&times;</button>
                <h4 class='modal-title'> Eliminar cierre_caja </h4>
              </div>
              <div class='modal-body'>
