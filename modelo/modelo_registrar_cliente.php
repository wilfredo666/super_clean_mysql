 ...
 <?php
  ...
  echo "INSERT INTO cliente (nombres ,apellidos ,ci_nit ,celular ,telefono ,email ,descuento ,sexo, tipo ) VALUES ( '$nombres' , '$apellidos' , '$ci_nit' , '$celular' , '$telefono' , '$email' , '$descuento' , '$sexo', '$tipo' )";
