<a href='javascript:void(0);' onclick='btn_listar_entrega();'> Volver </a>
<?php
    ...
    $count_query = pg_query("SELECT count(*) AS numrows FROM entrega WHERE codigo_ot ILIKE '%$txt_buscar%'");
    ...
    $query = pg_query("SELECT * FROM entrega WHERE codigo_ot ILIKE '%$txt_buscar%' OFFSET $offset LIMIT $per_page");
          ...
          <div class='modal-dialog modal-lg'>
            ...
            <div class='modal-content'>
              <div class='modal-header'>
                ...
                <h4 class='modal-title'> Examinar entrega </h4>
              </div>
