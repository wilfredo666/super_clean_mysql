 <a href='javascript:void(0);' onclick='btn_listar_tikeo_prenda();'> Volver </a>
<?php
    ...
    $count_query   = pg_query("SELECT DISTINCT codigo_tik FROM tikeo WHERE cliente ILIKE '%$txt_buscar%' OR codigo_tik LIKE '%$txt_buscar%' OR codigo_ot ILIKE '%$txt_buscar%'");
    $numrows = 0;
    ...
    $query = pg_query("SELECT DISTINCT codigo_tik FROM tikeo WHERE cliente ILIKE '%$txt_buscar%' OR codigo_tik ILIKE '%$txt_buscar%' OR codigo_ot ILIKE '%$txt_buscar%' OFFSET $offset LIMIT $per_page");
