<div class="row">
	...
	$sql_prenda = pg_query("SELECT * FROM prenda WHERE tipo_prenda='2' ORDER BY prenda ASC");
	$i = 0; 
	...
	?>		
			<tr align="center">
				...
				<td> <?php  echo $precio; echo "/ Metro"; ?> </td>
				 
				<td> <button class="btn btn-primary btn-md" onclick="btn_seleccionar_prenda_metro('<?php echo $id_prenda; ?>','<?php echo $portada; ?>');"> + </button></td>
	...
	<div class="col-lg-2 col-md-2 col-xs-12" >
		...
		<table align="center">
			<tr>
			<td colspan="2"> 
				<h6 style="font-weight: bold; text-align: center;"> Metros </h6>
				<div id="mensaje_prenda_seleccionada_metro"></div>
			</td>
		    </tr>

			<tr>
				<td> 
				<input type="text" id="medida_ropa_metro" class="form-control"  placeholder="* Medida"  onkeypress="return valida_numeros(event);" maxlength="10" style="width: 100%;">
		  		...
		  		<div align="center">
		  			...
		  			<table>
		  				...
		  				<tr>
		  					...
		  					<td> <button class="btn btn-default btn-lg"  onclick="btn_agregar_prenda_metro();" style="background: green; color: white; padding-left: 35%; padding-top: 25%; padding-bottom: 25%; padding-right: 35%; "> + </button> </td>
		  				</tr>
		  				<tr>
	...
	<div class="col-lg-5 col-md-5 col-xs-12" style="overflow-y: scroll; max-height: 450px;">
		...
		<div id="mensaje_carrito_orden_trabajo_metro">  
		</div>

		<div id="panel_modal_carrito_orden_trabajo_metro">
...
<script type="text/javascript">
	...
	function btn_teclado_numeros(valor)
	{
		...
		$("#medida_ropa_metro").val(cantidad);
	}
