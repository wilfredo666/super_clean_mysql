//resp_archivo
    ...
    function btn_mostrar_registro()
    {
     ...
     $.ajax({
      type: 'POST',
      url:'../vista/vista_carrito_acomodado.php',
      data: obj,
       beforeSend: function(objeto){
      },
      success:function(data){
        $('#panel_registro_carrito_acomodado').html(data).fadeIn('slow');
      }
    });
    }

    function btn_registro_carrito_acomodado(){
         ...
         if(id_cliente !='' && cliente !='' && id_usuario !='' && id_sucursal !='' && id_ot !='' && codigo_ot !='' && id_lugar !='' && lugar !='' && estado_acomodado !='' && codigo_tikeo !='' && tipo_lavado !='' && id_lavado !='' && id_prenda !='' ){ 
                ...
                { 
                 //alert(data);
                 $('#resultado_registro_carrito_acomodado').html(data);
                // setTimeout(limpiar_carrito_acomodado,1000);
                  ...
                  setTimeout(function(){
                    $('#resultado_registro_carrito_acomodado').html('');
                  },1000);
    ...
    function limpiar_carrito_acomodado()
    {
         $('#resultado_registro_carrito_acomodado').html('');
         $('#resp_img_carrito_acomodado').html('');
         $('#img_carrito_acomodado').val('');
    }
  ...
  function cargar_datos_buscar(page)
  {
    ...
    if(txt_buscar==''){
      $('#resp_busqueda_carrito_acomodado').html('<label style="color:red;"> !!Escribe en el campo para Buscar!! </label>');
    }

    else{
    $('#resp_busqueda_carrito_acomodado').html('');
    ...
    $.ajax({
      url:'../modelo/modelo_buscar_carrito_acomodado.php',
      data: parametros,
       beforeSend: function(objeto){
       $('#loader').html('cargando .... ');
      },
