//resp_archivo
    ...
    function btn_mostrar_registro()
    {
     ...
     $.ajax({
      type: 'POST',
      url:'../vista/vista_cargo.php',
      data: obj,
       beforeSend: function(objeto){
      },
      success:function(data){
        $('#panel_registro_cargo').html(data).fadeIn('slow');
      }
    });
    }

    function btn_registro_cargo(){
         ...
         if(cargo !='' ){ 
                ...
                $.ajax({
                type: 'POST',
                url:'../modelo/modelo_registrar_cargo.php',
                data: ob,
                beforeSend: function(objeto){
                ...
                { 
                 //alert(data);
                 $('#resultado_registro_cargo').html(data);
                // setTimeout(limpiar_cargo,1000);

                 
                  $('#cargo').val('');
                 
                  setTimeout(function(){
                    $('#resultado_registro_cargo').html('');
                  },1000);
  ...
  function cargar_datos_buscar(page)
  {
    ...
    if(txt_buscar==''){
      $('#resp_busqueda_cargo').html('<label style="color:red;"> !!Escribe en el campo para Buscar!! </label>');
    }

    else{
    $('#resp_busqueda_cargo').html('');
    ...
    $.ajax({
      url:'../modelo/modelo_buscar_cargo.php',
      data: parametros,
       beforeSend: function(objeto){
       $('#loader').html('cargando .... ');
      },
